...
class slideToUnlock {
    constructor(el, options) {
        ...
        if (!("lockText" in this.settings)) {
            this.settings.lockText = "Check-out";
        }
    ...
    touchEnd(event = window.event) {
        ...
        function redirect() {
            // $(location).attr('href', 'logged-out.html');
            $("#page2").hide();
            $("#page3").show();
            // $("#outTxt").append("Goodbye " + document.getElementById('name').value);
        ...
        //
        //
        // if ($(document).attr('title') == 'Check-in') {
        //     // document.getElementById('jsform').submit();
        //     // $('butt').submit()
        //     // $('#butt').submit();
        //     // $('jsform').select(function(){
        //     //     $('jsform').submit();
        //     // });
        //     $(location).attr('href', 'logged-out.html');
        // } else {
